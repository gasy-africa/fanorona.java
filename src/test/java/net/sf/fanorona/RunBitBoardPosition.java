...
public class RunBitBoardPosition {
    ...
    public void boardNumbers() {
        ...
        System.out.println("Black       = 0b"+Bits.fill64(Long.toBinaryString(black)));
        System.out.println("White       = 0b"+Bits.fill64(Long.toBinaryString(white)));
		for (int row=0, Col=5;row<=4;row++,Col--) {
			for (int col=0;col<=8;col++) {
				long b = Bits.at(row, col);
				System.out.println("("+row+","+col+") ["+Col+","+Row.get(col)+"] = 0b"+Bits.fill64(Long.toBinaryString(b)));
			}
		}
        System.out.println("White       = 0b"+Bits.fill64(Long.toBinaryString(white)));
	}
	...
	public void constantInBinary() {
        ...
        System.out.println("INITIAL_BOT = 0b" + Bits.fill64(Long.toBinaryString(Bits.INITIAL_BOT)));
        System.out.println("INITIAL_TOP = 0b" + Bits.fill64(Long.toBinaryString(Bits.INITIAL_TOP)));
        System.out.println("TOP_ROW     = 0b" + Bits.fill64(Long.toBinaryString(Bits.TOP_ROW)));
        System.out.println("BOTTOM_ROW  = 0b" + Bits.fill64(Long.toBinaryString(Bits.BOTTOM_ROW)));
        System.out.println("LEFT_COL    = 0b" + Bits.fill64(Long.toBinaryString(Bits.LEFT_COL)));
        System.out.println("RIGHT_COL   = 0b" + Bits.fill64(Long.toBinaryString(Bits.RIGHT_COL)));
        System.out.println("DIAGONAL    = 0b" + Bits.fill64(Long.toBinaryString(Bits.DIAGONAL)));
        System.out.println("ON_BOARD    = 0b" + Bits.fill64(Long.toBinaryString(Bits.ON_BOARD)));
        System.out.println("CENTER      = 0b" + Bits.fill64(Long.toBinaryString(Bits.CENTER)));
    }
